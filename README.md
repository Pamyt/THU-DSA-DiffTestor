...
🌐 **在线访问**: [http://thu-dsa-difftestor.com](http://thu-dsa-difftestor.com)
...
### 1. 访问网站
打开 [http://thu-dsa-difftestor.com](http://thu-dsa-difftestor.com)
...
由于测试数据生成的局限性，**在本系统上通过不代表一定能在 OJ 上通过**，且由于评测机性能的局限性，本系统**仅适用于检测Wrong Answer错误**。
...
**本项目仅供学习交流使用，严禁用于违反学术诚信的行为。平台不会保存任何用户提交的cpp文件。**
